...
static void CPE_HackControl(cc_uint8* data) {
	...
	p->Hacks.CanFly            = true;// data[0] != 0;
	p->Hacks.CanNoclip         = true;// data[1] != 0;
	p->Hacks.CanSpeed          = true;// data[2] != 0;
	p->Hacks.CanRespawn        = true;// data[3] != 0;
	p->Hacks.CanUseThirdPerson = true;// data[4] != 0;
